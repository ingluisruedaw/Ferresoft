...
<head>
	...
	<link rel="stylesheet" href="../../estilos/login/facturacion.css">
<link rel="stylesheet" href="../../estilos/login/login.js">
</head>
<body>
	<div class="login-page"><!--class="login-page"-->
	  <div class="form" style="background-color: rgba(255, 255, 255, 0.8);">
	    <h3 st>AUTENTICACIÓN FACTURACIÓN</h3>
	  	<img src="../../images/login/login.png">  
	    <p><b>DEBES DIGITAR TU USUARIO Y CONTRASEÑA PARA AUTENTICARTE EN EL SISTEMA CON TU ROL</b></p>
	    <form class="login-form" action="../../controlador/login/facturacion.php" method="post">
