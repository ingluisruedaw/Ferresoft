<div class="navbar-header">
    <a class="navbar-brand" href="index.php">Panel Inventario</a>
</div>
...
<ul class="nav navbar-right navbar-top-links">
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-user">
            <li>
                <a href="" data-toggle="modal" data-target="#ModalActualizar" type="submit" ><i class="fa fa-user fa-fw"></i> Cambiar Clave</a>
            </li>
