              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <button type="submit" class="botones" id="botonActualizar" data-toggle="modal" data-target="#ModalUActializacion" onclick="setCapturaValores('<?php echo $captureU; ?>','<?php echo $r->__GET('roles_id');?>','<?php echo $r->__GET('empleados_id');?>')">Actualizar</button>
                    </td>
                    <td>
