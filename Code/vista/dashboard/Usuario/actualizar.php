      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="?action=actualizar_clave_usuario" method="post" name="actualizarclavePass">
            <div class="form-group">
              <label for="modalActualizarClaveUc">Nueva Clave: </label>
              <input type="hidden" class="form-control" id="modal_usuario_n" name="modal_usuario_n">
              <input type="password" class="form-control" id="modalActualizarClaveUc" name="modalActualizarClaveUc">
            </div>
          </form>
...
<script>
  setCapturaValores = function(usuario, rol, empleado){
